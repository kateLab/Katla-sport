...
namespace KatlaSport.DataAccess
{
    ...
    public sealed class DependencyRegistrationModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<EmployeeShop.EmployeeContext>().As<EmployeeShop.IEmployeeContext>();
            builder.RegisterType<EmployeeDepartment.DepartmentContext>().As<EmployeeDepartment.IDepartmentContext>();
            builder.RegisterType<ShopsNetwork.ShopContext>().As<ShopsNetwork.IShopContext>();
