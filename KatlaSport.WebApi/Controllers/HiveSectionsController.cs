...
namespace KatlaSport.WebApi.Controllers
{
    ...
    public class HiveSectionsController : ApiController
    {
        ...
        [SwaggerResponse(HttpStatusCode.InternalServerError)]
        public async Task<IHttpActionResult> AddHiveSection([FromBody] UpdateHiveSectionRequest createSectionRequest)
        {
            ...
            var hiveSection = await _hiveSectionService.CreateHiveSectionAsync(createSectionRequest);
        ...
        [SwaggerResponse(HttpStatusCode.NotFound)]
        [SwaggerResponse(HttpStatusCode.InternalServerError)]
        public async Task<IHttpActionResult> UpdateHiveSection([FromUri] int hiveSectionId, [FromBody] UpdateHiveSectionRequest updateSectionRequest)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            await _hiveSectionService.UpdateHiveSectionAsync(hiveSectionId, updateSectionRequest);
            return ResponseMessage(Request.CreateResponse(HttpStatusCode.NoContent));
        }
